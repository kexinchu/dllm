...
OUT_FILE   = os.path.join(DLLM_DIR, 'exp_overhead_bench.json')
...
approaches = [
    ...
    ("C_DetermLLM",         "DetermLLM (ours)"),
    ("D_TorchDet",          "torch.use_deterministic_algorithms"),
    ("E_FullFP32",          "Full FP32 (LayerCast)"),
]
